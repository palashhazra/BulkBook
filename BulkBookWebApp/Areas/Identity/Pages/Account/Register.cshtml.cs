...
namespace BulkBookWebApp.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            UserManager<IdentityUser> userManager,  //IdentityUser
            IUserStore<IdentityUser> userStore,   //IdentityUser
            SignInManager<IdentityUser> signInManager,   //IdentityUser
        ...
        private IUserEmailStore<IdentityUser> GetEmailStore()    //IdentityUser
        {
            if (!_userManager.SupportsUserEmail)
            {
                throw new NotSupportedException("The default UI requires a user store with email support.");
            }
            return (IUserEmailStore<IdentityUser>)_userStore;   //IdentityUser
        }
    }
}
